...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    // Map legacy variants to shadcn variants for backward compatibility
    let mappedVariant: 'default' | 'destructive' | 'outline' | 'secondary' | 'ghost' | 'link' | undefined = variant as any
